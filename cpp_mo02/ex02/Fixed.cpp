...
/*   Updated: 2025/04/29 08:12:06 by yussaito         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed& Fixed::max(Fixed& a, const Fixed& b) { return (a > b) ? a : const_cast<Fixed&>(b); }
Fixed& Fixed::max(const Fixed& a, Fixed& b) { return (a > b) ? const_cast<Fixed&>(a) : b; }
